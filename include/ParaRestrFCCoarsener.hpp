...
class ParaRestrFCCoarsener
  : public ParaRestrCoarsener
{
...
public:
  ...
  ParaRestrFCCoarsener(int rank, int nProcs, int nParts, int verVisOrder, int divByWt, int divByLen, ostream &out);
