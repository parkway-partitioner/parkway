...
class VCycleBisectionController
...
public:
  ...
  VCycleBisectionController(const int nRuns, const double kT, const double redFactor, int eeParam, int percentile, int inc, int dispL, ostream &out);
