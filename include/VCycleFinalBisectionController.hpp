...
class VCycleFinalBisectionController
  : public VCycleBisectionController
{
...
public:
  ...
  VCycleFinalBisectionController(int nRuns, double kT, double redFactor, int eeParam, int percentile, int inc, int dispL, ostream &out);
