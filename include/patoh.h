...
typedef struct {
  ...
  /*----------------- V-cycle parameter ----------------*/
  int bigVcycle, smallVcycle, usesamematchinginVcycles;
  ...
  int MemMul_CellNet, MemMul_Pins, MemMul_General;

  /* ================ Coarsening Parameters ================ */
  int crs_VisitOrder; /* PATOH_VO_... */
  int crs_alg;        /* PATOH_CRS_... */
  int crs_coarsento, crs_coarsentokmult, crs_coarsenper;
  ...
  int ref_passcnt, ref_maxnegmove;
  float ref_maxnegmovemult;
  int ref_dynamiclockcnt;

  /* -------------- imbalance parameters--------------*/
  double init_imbal, final_imbal, fast_initbal_mult;
  float init_sol_discard_mult, final_sol_discard_mult;
...
int PaToH_Check_Hypergraph(int _c, int _n, int _nconst, int *cwghts,
                           int *nwghts, int *xpins, int *pins);
...
int PaToH_MultiConst_Partition(PPaToH_Arguments pargs, int _c, int _n,
                               int _nconst, int *cwghts, int *xpins, int *pins,
