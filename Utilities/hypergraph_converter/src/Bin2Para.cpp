...
void Bin2Para::convert(const char* filename)
{
  ...
  for (i=0;i<numProcessors;++i)
      ...
      else
	{
      ...
      buildParaFile(in_stream, out_stream, para_file, inLoc, inData, minVertexIndex);
    }
...
void Bin2Para::buildParaFile(ifstream &in_stream, ofstream &out_stream, const char *p_file, int &inStream, int &inData, int minVertIdx)
{
  register int i;
  ...
  out_stream.write((char*)(&vWeights[minVertIdx]),sizeof(int)*numLocVertices);
