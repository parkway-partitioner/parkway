...
first_choice_coarsener::first_choice_coarsener(int _min, int _maxwt, double r, int fanOut, int dbWt,
                         int dL)
...
serial::hypergraph *first_choice_coarsener::coarsen(const serial::hypergraph &h) {
