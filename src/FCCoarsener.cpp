...
FCCoarsener::FCCoarsener(int _min, int _maxwt, double r, int fanOut, int dbWt, int dL)
...
#  endif
  ...
  return (buildCoarseHypergraph(coarseWts->getArray(), coarseIndex, h.getTotWeight()));
}
