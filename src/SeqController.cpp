...
void SeqController::initCoarsestHypergraph(ParaHypergraph &hgraph, MPI_Comm comm)
{
  register int i;
  register int j;
  register int ij;
...
#  endif
  ...
  return(static_cast<int>(floor(static_cast<double>(bestCut)+bestCut*acceptProp)));
}
