...
ParaHypergraphLoader::ParaHypergraphLoader(int rank, int nProcs, int nParts, ostream &o)
...
void ParaHypergraphLoader::computeHedgesToLoad(BitField &toLoad, int numH, int numLocalPins, int *hEdgeWts, int *hEdgeOffsets, MPI_Comm comm)
{
  register int i;
  register int j;
