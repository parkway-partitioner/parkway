...
public:
  ...
  RecurBisectController(BisectionController *b, GreedyKwayRefiner *k, int rank, int nProcs, int nParts, int nBisectRuns, ostream &out);
  ...
  void splitBisection(const Bisection &b, Bisection* &newB, MPI_Comm comm) const;
