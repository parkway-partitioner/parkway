...
public:
  ...
  inline int *getRestoringMovesLens() const { return restoringMovesLens.getArray(); }
  inline FastDynaArray<int> **getRestoringMoves() const { return restoringMoves.getArray(); }
