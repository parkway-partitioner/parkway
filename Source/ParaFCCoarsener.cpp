...
ParaFCCoarsener::ParaFCCoarsener(int rank, int nProcs, int nParts, int vertVisOrder, int matchReqOrder, int divByWt, int divByLen, ostream& out)
...
void ParaFCCoarsener::buildAuxiliaryStructs(int numTotPins, double aveVertDeg, double aveHedgeSize)
{
  // ###
...
int ParaFCCoarsener::accept(int locVertex, int nonLocCluWt, int highToLow, int maxWt)
{
