...
template<class T>
CompleteBinaryTree<T>::CompleteBinaryTree(const T *rootVals, const int *cmprs, int nRoots)
{
...
template<class T>
void CompleteBinaryTree<T>::setupTree(const T *rootVals, const int *cmprs, int nRoots)
{
  numRoots = nRoots;
...
template<class T>
void CompleteBinaryTree<T>::fill(const int *cmprs)
{ 
  int i = 0;
  int j = 0;
